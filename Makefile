...
LDFLAGS := $(LDFLAGS) -X github.com/kimicao1010/alert-webhook/pkg/version.Version=$(APP_VERSION)
LDFLAGS := $(LDFLAGS) -X github.com/kimicao1010/alert-webhook/pkg/version.Commit=$(GIT_COMMIT)
LDFLAGS := $(LDFLAGS) -X github.com/kimicao1010/alert-webhook/pkg/version.BuildAt=$(BUILD_TIME)
